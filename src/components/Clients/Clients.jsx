...
let clients = [
    ...
    },
    {
        ...
        stars : 4,
        disc : `Principal stack utilizada onde uso em praticamente todas as minhas APIs`
    },
    {
        name:"Typescript",
        position : "Avançado",
        ...
        stars : 4,
        disc : `Largamente utilizado em praticamente todas as aplicações que construi.`
    },
    {
        name : "Next.js",
        position : "Intermediario",
  ...
  return (
    <Container id='client'>
        <Slide direction="left">
            ...
            <h1>Conhecimentos nas stacks</h1>
        </Slide>
        <Testimonials>
